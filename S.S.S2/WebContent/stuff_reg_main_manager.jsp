...
<% request.setCharacterEncoding("utf-8"); %>
    ...
    <div class="stuff_main" style="width:24.2% ;margin-right:8px;margin-top:8px;">
  		<div class="card">
			<div class="img">
			<img src="upload/${dto.file}" alt="..." style="width:365px;height: 220px">
			...
			<div class="text">
				...
				<p>위치: ${dto.position}</p>
				<p>내용: ${dto.context}</p>
				<a href="stuff_reg_details_manager.do?bcontext=${dto.context}" style="text-decoration: none;">자세히보기</a>
			</div>	
  		</div>
	</div>
	</c:forEach>
	<button class="stuff_button" style="margin-left: 1370px; margin-bottom: 8px"><a href="stuff_reg.jsp" style="color:black; text-decoration: none;">물품 등록하러가기</a></button>
	</div>
