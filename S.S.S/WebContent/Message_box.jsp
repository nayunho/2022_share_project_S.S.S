...
<body>
    ...
    <br><br><br><br>
    <div class="messageMcontainer">
    	<div class="message_title">
    		<h2 style="line-height: 60px;">주고받은 메세지 목록</h2>
    	</div>
    		<c:forEach items="${message_hero}" var="dto1" varStatus="status">
    		<div class="message_list" style="margin-top: 10px;">
    			<div class="message_hero" ><h2><a href="chatting.jsp?toID=${dto1.fromID}" style="text-decoration: none;color:black">${dto1.fromID}</a></h2></div>
