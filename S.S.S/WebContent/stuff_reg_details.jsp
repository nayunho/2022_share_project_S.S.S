    ...
    <br><br><br>
    	<table >
    		...
    		<tr>
    			...
    			<td style="width:70%"> <h3>${content_view.nicname } (${email_hero})</h3></td>
    		</tr>
    		<tr>
    	...
    	<button class="stuff_button" style="margin-left: 1260px; margin-bottom: 8px; padding: 0 20px;"><a href='chatting.jsp?toID=${content_view.toID }' style="color:black; text-decoration: none;">채팅 하러가기</a></button>
    		...
    		<div class="stuff_main" style="width: 30%;margin-right:8px;margin-bottom: 8px;">
  				<div class="card">
					...
					<div class="text">
						...
						<p style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">내용: ${Similar_dto.context}</p>
						<a href="stuff_reg_details.do?bcontext=${Similar_dto.context}" style="text-decoration: none;">사러가기</a>
					</div>	
  				</div>
			</div>
		</c:forEach>
