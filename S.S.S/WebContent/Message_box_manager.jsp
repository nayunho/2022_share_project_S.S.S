...
<body>
    ...
    <div class="messageMcontainer">
    	<div class="message_title">
    		...
    		<c:forEach items="${message_hero}" var="dto1">
    		<div class="message_list" style="margin-top: 10px;">
    			<div class="message_hero" ><h2><a href="chatting_manager.jsp?toID=${dto1.fromID}" style="text-decoration: none;color:black">${dto1.fromID}</a></h2></div>
