...
<head>   
        <%  
        String userID = (String)session.getAttribute("nicname"); 
        String toID = null;
...
<body>
    ...
    <div class="main_Logo_menu">
        ...
        <ul class="category">
            ...
            <li>
                <a>메세지</a>
                <ul>
                    <li><a href="message_show_manager.do?dbnicname=<%=userID  %>" style="text-decoration: none; color:black;">메세지 함</a></li>
                </ul>
            </li>
            <li>
                <a>회원</a>
    ...
    <div class="Login">
       <h3><%= userID  %>님 안녕하세요! &nbsp;<a class="logout" type="button" href="main.jsp">로그아웃</a> </h3>
